...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:xlink1="http://www.w3.org/TR/xlink" 
    xmlns:xlink2="http://www.w3.org/1999/xlink"
    version="1.0" mets:dummy-for-xmlns="" dc:dummy-for-xmlns="" rdf:dummy-for-xmlns=""
    xlink1:dummy-for-xmlns="" xlink2:dummy-for-xmlns="" exclude-result-prefixes="rdf sch xlink1 xlink2 mets xsl dc dcterms">
    <axsl:output method="xml"/>
    <xsl:template match="/">
        <xsl:call-template name="errors"/>
    </xsl:template>
    <axsl:template name="errors">
        <MetsBestPracticeErrors xsl:exclude-result-prefixes="mets xsl axsl sch dc rdf xlink1 xlink2">
    ...
    <axsl:template match="mets:dmdSec[3]" priority="3999" mode="M6">
        <axsl:choose>
            <axsl:when test="/mets:mets/mets:dmdSec/@ID='ead'"/>
            <axsl:otherwise>
    ...
    <axsl:template match="mets:dmdSec[4]" priority="3998" mode="M6">
        <axsl:choose>
            <axsl:when test="/mets:mets/mets:dmdSec[4]/@ID='repo'"/>
            <axsl:otherwise>
