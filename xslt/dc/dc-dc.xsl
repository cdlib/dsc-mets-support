...
<xsl:template name="creator">
	<xsl:call-template name="element">
                ...
                <xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:creator | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:creator"/>
...
<xsl:template name="subject">
        <xsl:call-template name="element">
                ...
                <xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:subject | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:subject"/>
        </xsl:call-template>
        <xsl:call-template name="element">
                <xsl:with-param name="element">subject</xsl:with-param>
...
<xsl:template name="description">
	<xsl:call-template name="element">
                ...
                <xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:description | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:description"/>
        </xsl:call-template>
</xsl:template>
...
<xsl:template name="publisher">
	<xsl:call-template name="element">
                ...
                <xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:publisher | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:publisher"/>
        </xsl:call-template>
</xsl:template>
...
<xsl:template name="contributor">
	<xsl:call-template name="element">
		...
		<xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:contributor | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:contributor"/>
	</xsl:call-template>
</xsl:template>
...
<xsl:template name="date">
	<xsl:call-template name="element">
                ...
                <xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:date | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:date"/>
        </xsl:call-template>
</xsl:template>
...
<xsl:template name="format">
	<xsl:call-template name="element">
		...
		<xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:format | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:format"/>
	</xsl:call-template>
</xsl:template>
...
<xsl:template name="identifier">
	...
	<xsl:call-template name="element">
		...
		<xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:identifier | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:identifier"/>
	</xsl:call-template>
</xsl:template>
...
<xsl:template name="source">
	<xsl:call-template name="element">
		...
		<xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:source | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:source"/>
	</xsl:call-template>
</xsl:template>
...
<xsl:template name="language">
	<xsl:call-template name="element">
		...
		<xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:language | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:language"/>
	</xsl:call-template>
</xsl:template>
...
<xsl:template name="relation">
	<xsl:call-template name="element">
		...
		<xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:relation | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:relation"/>
	</xsl:call-template>
	<xsl:call-template name="element">
		<xsl:with-param name="element" select="'relation'"/>
...
<xsl:template name="coverage">
	<xsl:call-template name="element">
		...
		<xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:coverage | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:coverage"/>
	</xsl:call-template>
</xsl:template>
...
<xsl:template name="rights">
	<xsl:call-template name="element">
		...
		<xsl:with-param name="node" select="/m:mets/m:dmdSec[@ID='dc']/m:mdWrap/m:xmlData/cdl:qualifieddc/dc:rights | /m:mets/m:dmdSec[@ID='DC']/m:mdWrap/m:xmlData/dc:rights"/>
	</xsl:call-template>
</xsl:template>
